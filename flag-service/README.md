...
```bash
curl -X POST http://flag-service:8002/flags \
-H "Content-Type: application/json" \
...
curl -X POST http://flag-service.flag-ns:30002/flags \
-H "Content-Type: application/json" \
-H "Authorization: Bearer tm_key_8e9524466a89e78b18b8f71eb6339f9f1684298f2682509241a3bfb15034e1da" \
-d '{
    "name": "enable-new-dashboard",
...
```bash
curl http://flag-service.flag-ns:30002/flags \
-H "Authorization: Bearer tm_key_72251c40e654b5f58e2d5222458fb9721a614455e1f8b736ca216bd0916f89df"
```
